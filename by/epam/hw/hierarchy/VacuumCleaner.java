...
public class VacuumCleaner extends ElectricalDevice implements Serializable {
	...
	public VacuumCleaner(String typeOfDevice, String brand, int weight, String type, int powerConsumption,
			String filterType, String bagType, String wandType, int motorSpeedRegulation, int cleaningWidth) {
		super("Vacuum Cleaner", brand, weight, type, powerConsumption);
